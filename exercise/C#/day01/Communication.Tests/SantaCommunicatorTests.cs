...
namespace Communication.Tests
{
    public class SantaCommunicatorTests
    {
        ...
        public void ComposeMessage()
            => _communicator.ComposeMessage(new ReindeerTravelInfo(Dasher, NorthPole, 5))
                .Should()
        ...
        {
            var overdue = _communicator.IsOverdue(new ReindeerTravelInfo(Dasher, NorthPole, NumberOfDayBeforeChristmas), _logger);
        ...
        public void ShouldReturnFalseWhenNoOverdue()
            => _communicator.IsOverdue(new ReindeerTravelInfo(Dasher, NorthPole, NumberOfDayBeforeChristmas - NumberOfDaysToRest - 1), _logger)
                .Should()
                .BeFalse();
    }
}